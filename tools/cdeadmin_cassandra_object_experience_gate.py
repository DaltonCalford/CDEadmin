...
"""Gate Cassandra wide-column navigator and object-editor declarations."""
...
def provider_catalog(live_evidence_paths=()):
    adapter = CassandraClient.__new__(CassandraClient)
    catalog = enrich_engine_experience(
        adapter.visual_admin_catalog(catalog_for_engine('cassandra'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.cassandra-object-gate.v1',
        'gate': 'cassandra-wide-column-object-experience',
