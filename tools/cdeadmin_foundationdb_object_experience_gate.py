...
"""Gate FoundationDB key/value navigator and object-editor declarations."""
...
def provider_catalog(live_evidence_paths=()):
    adapter = FoundationDBBackend.__new__(FoundationDBBackend)
    catalog = enrich_engine_experience(
        adapter.visual_admin_catalog(catalog_for_engine('foundationdb'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.foundationdb-object-gate.v1',
        'gate': 'foundationdb-key-value-object-experience',
