...
"""Gate OpenSearch search navigator and object-editor declarations."""
...
def provider_catalog(live_evidence_paths=()):
    adapter = OpenSearchClient.__new__(OpenSearchClient)
    catalog = enrich_engine_experience(
        adapter.visual_admin_catalog(catalog_for_engine('opensearch'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.opensearch-object-gate.v1',
        'gate': 'opensearch-search-object-experience',
