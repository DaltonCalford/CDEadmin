...
"""Gate the YugabyteDB YCQL wide-column object experience."""
...
from pgadmin.cdeadmin.visual_admin import (  # noqa: E402
    apply_live_evidence, enrich_engine_experience, load_live_evidence,
)


def provider_catalog(live_evidence_paths=()):
    adapter = YugabyteDBYCQLClient()
    catalog = enrich_engine_experience(adapter.visual_admin_catalog({}))
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.yugabytedb-ycql-object-gate.v1',
        'gate': 'yugabytedb-ycql-wide-column-object-experience',
