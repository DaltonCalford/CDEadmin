...
"""Tests for the ClickHouse columnar and semantic object gate."""

import unittest

from tools.cdeadmin_clickhouse_object_experience_gate import audit


class ClickHouseObjectExperienceGateTestCase(unittest.TestCase):
