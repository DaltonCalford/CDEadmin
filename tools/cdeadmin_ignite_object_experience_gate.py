...
"""Gate Apache Ignite navigator/editor declarations and live evidence."""
...
def provider_catalog(live_evidence_paths=()):
    ...
    catalog = enrich_engine_experience(
        backend.visual_admin_catalog(catalog_for_engine('apache_ignite'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.apache-ignite-object-gate.v1',
        'gate': 'apache-ignite-relational-key-value-object-experience',
