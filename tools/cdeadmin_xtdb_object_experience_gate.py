...
"""Gate XTDB dual document/relational navigator and editor declarations."""
...
def provider_catalog(live_evidence_paths=()):
    adapter = XTDBClient.__new__(XTDBClient)
    catalog = enrich_engine_experience(
        adapter.visual_admin_catalog(catalog_for_engine('xtdb'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.xtdb-object-gate.v1',
        'gate': 'xtdb-dual-object-experience',
