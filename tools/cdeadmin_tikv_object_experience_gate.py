...
"""Gate TiKV key/value navigator and object-editor declarations."""
...
from pgadmin.cdeadmin.providers.tikv.client import TiKVBackend  # noqa: E402
...
def provider_catalog(live_evidence_paths=()):
    adapter = TiKVBackend.__new__(TiKVBackend)
    catalog = enrich_engine_experience(
        adapter.visual_admin_catalog(catalog_for_engine('tikv'))
    )
...
def audit(live_evidence_paths=()):
    ...
    return {
        'schema': 'cdeadmin.tikv-object-gate.v1',
        'gate': 'tikv-key-value-object-experience',
