...
export default class ERDTool extends React.Component {
  ...
  onSQLClick(sqlWithDrop=false) {
    let scriptHeader = gettext('-- This script was generated by the ERD tool in CDEadmin.\n');
    scriptHeader += gettext('-- Report CDEadmin defects through the designated CDEadmin project channel, including reproduction steps.\n');
