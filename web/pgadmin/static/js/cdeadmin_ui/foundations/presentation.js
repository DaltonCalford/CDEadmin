...
export function presentationThemeOverrides(presentation) {
  ...
  return {
    ...
    palette: {
      ...
      success: {main: colors.success, light: colors.panel,
        contrastText: contrastText(colors.success)},
      warning: {main: colors.warning, light: colors.panel,
        contrastText: contrastText(colors.warning)},
      error: {main: colors.error, light: colors.panel,
        contrastText: contrastText(colors.error)},
      info: {main: colors.info || colors.primary, light: colors.panel,
        contrastText: contrastText(colors.info || colors.primary)},
      default: {
        main: colors.panel,
